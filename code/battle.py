...
class Battle:
    def __init__(self, player_monsters, oppenent_monsters, monster_frames, bg_surf, fonts, end_battle, character, sounds):
        ...
        if self.selection_mode and self.current_monster:
            ...
            if keys[pygame.K_SPACE]:
                ...
                if self.selection_mode == 'switch':
                    index, new_monster = list(self.avaliable_monsters.items())[self.indexes['switch']]
                ...
                if self.selection_mode == 'target' and self.selected_attack:
